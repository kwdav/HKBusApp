...
extension BusListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.font = UIFont.systemFont(ofSize: 13, weight: .semibold) // Slightly larger and bolder
        label.textColor = UIColor(white: 0.9, alpha: 1.0) // Better contrast
        ...
        NSLayoutConstraint.activate([
            label.leadingAnchor.constraint(equalTo: headerView.leadingAnchor, constant: 6), // More padding
